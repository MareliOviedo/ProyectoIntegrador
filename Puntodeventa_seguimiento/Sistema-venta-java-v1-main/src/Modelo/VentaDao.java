...
public class VentaDao {
    ...
    public boolean RegistrarVenta(Venta v, double descuento){
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            doc.open();
            java.net.URL logo = getClass().getResource("/Img/logo_pdf.png");
            Image img = null;
            if (logo != null) {
            ...
            double subtotalTicket = total + descuentoTicket;
            double porcentajeTicket = subtotalTicket > 0 ? (descuentoTicket * 100.00) / subtotalTicket : 0.00;

            Paragraph info = new Paragraph();
            info.add(Chunk.NEWLINE);
            info.add("Subtotal: $" + String.format("%.2f", subtotalTicket) + "\n");
            if (descuentoTicket > 0) {
                info.add("Descuento (" + String.format("%.2f", porcentajeTicket) + "%): $" + String.format("%.2f", descuentoTicket) + "\n");
            }
            info.add("Monto a pagar: $" + String.format("%.2f", total));
            ...
            JOptionPane.showMessageDialog(null, "La venta se guardó, pero no se pudo generar/abrir el PDF: " + e.getMessage());
            System.out.println(e.toString());
        }
    }
